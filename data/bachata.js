...
const BACHATA = {
  ...
  parts: [
    { t: "Intro", d: "Entrada. Instrumentación mínima: güira y bajo marcan el pulso, la guitarra insinúa." },
    { t: "Verso", d: "La historia. Groove básico: güira + bongó (martillo 3-4-7-8) + bajo." },
    { t: "Majao", d: "Sección energética (mambo). Bongó a lo loco, güira continua, entra fuerte la guitarra." },
    { t: "Derecho", d: "El tramo recto y potente. Todo el groove empuja hacia adelante." },
  ],
